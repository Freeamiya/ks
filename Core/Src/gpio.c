...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_Pin|SCLK_Pin|SDO_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SR04_TRIG_GPIO_Port, SR04_TRIG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_Pin SCLK_Pin SDO_Pin */
  GPIO_InitStruct.Pin = LED_Pin|SCLK_Pin|SDO_Pin;
